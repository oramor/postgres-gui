...
namespace Gui.Desktop.Forms
{
    public partial class DataRecordForm : Form // BaseRecordForm
    {
        ...
        void BindControls()
        {
            ...
            /// Аналогично с гридами. Причем они обязательно
            /// подписываются на событие FormClosing, что позволяет
            /// сохранить настройки колонок перед закрытием
            /// Так же должны отменяться все фоновые операции
            /// загрузки
        }
